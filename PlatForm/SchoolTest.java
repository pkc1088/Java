...
public class SchoolTest {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch(cmd) {
                case ADD: {
                    ttStudent newStudent = createStudent();
                    pnu.addStudent(newStudent);
                    break;
                }
                case FIND:
                    findStudent(pnu); break;
                case CLEAR:
                    pnu.removeAllStudent(); break;
                case LIST:
                    System.out.println(pnu); break;
                default:break;
            }
        }
    }
    ...
    private static void findStudent(final School school) {
        ...
        final ttStudent foundStudent = school.findStudent(studentName, schoolYear);
        if(foundStudent != null)
            System.out.println(foundStudent);
        else
            System.out.println("StudentNot Found with name "+studentName
                              +" and year"+schoolYear);
    }

    private static ttStudent createStudent() {
        final String studentName = scanner.next();
        final int schoolYear = scanner.nextInt();
        return new ttStudent(studentName, schoolYear);
    }
